...
#let stakeholders-table = [
  #figure(
    table(
      ...
      [SI-2 <stake:si-2>], [Dpt. Biology of Organisms and Systems of the University of Oviedo],
      ...
      [SI-5 <stake:si-5>], [Mario Quevedo de Anta],
        [TFG co-tutor belonging to the Biology School],
      ...
      [SE-2 <stake:se-2>], [Other biology schools and research groups],
        [Some other biology schools and research groups that might find this tool useful for their activity],
